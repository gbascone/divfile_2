...
var rtt = function(f,tws,c,o,lis,wh) {	
	var h = c.parent().find('.tp-'+wh+'s'),
		ins = h.find('.tp-'+wh+'categorias-inner-wrapper'),
...
var addThumb = function(container,o,li,what,opt) {
	...
	if (container.parent().find(thumbs).length===0) {
		...
		var spanw = o.span===true ? "tp-span-wrapper" : "",
			addcontent = '<div class="'+what+'categorias '+spanw+" "+o.position+" "+o.style+'"><div class="'+what+'-mask"><div class="'+what+'categorias-inner-wrapper" style="position:relative;"></div></div></div>';
