    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Usuario | Lista </h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php url('admin')?>">Inicio</a>
                            </li>
                            <li class="breadcrumb-item"><a href="<?php url('usuarios/lista')?>">Usuario</a>
                            </li>
                        ...
                        <div class="card-head">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a class="btn btn-primary btn-sm" href="<?php url('usuario/index' .('?page=nuevo'))?>"><i class="ft-plus white"></i>Agregar un usuario</a>
                                                ...
                                                <td>
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body media-middle">
                                                            <a href="#" class="media-heading"><?php echo utf8_encode($usuario->usuario) ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-left">
                                                    <a><?php echo utf8_encode($usuario->email)?></a>
                                                </td>
                                                <td class="text-left">
                                                    <?php
                                                    ...
                                                    <a><?php echo utf8_encode($perfil)?></a>
                                                </td>
                                                <td>
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                  <a href="<?php url('usuario/editar/' . $usuario->id . '/' .('?page=editar') )?>" class="dropdown-item"><i class="ft-edit-2"></i>Editar</a>
                                  <a href="<?php url('usuario/perfil/' .$usuario->id)?>" class="dropdown-item"><i class="ft-plus-circle primary"></i>Consultar</a>
                                    <button id="eliminar" href="#" class="dropdown-item" onclick="confirmar('<?php url('usuario/eliminar/' . $usuario->id )?>')"><i class="ft-trash-2"></i>Eliminar</button>
                                </span>
                              </span>
                                                </td>
                                            </tr>
