    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Artículo | Lista </h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php url('admin') ?>">Inicio</a>
                            </li>
                            <li class="breadcrumb-item"><a href="<?php url('articulo/lista') ?>">Articulo</a>
                            </li>
                    ...
                    <div class="card">
                        <div class="card-head">
                            <div class="card-header">
                                <h4 class="card-title">Lista de Articulo</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <a class="btn btn-primary btn-sm"
                                       href="<?php url('articulo/index' . ('?page=nuevo')) ?>"><i
                                                class="ft-plus white"></i>Agregar un artículo</a>
                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body media-middle">
                                                                    <a href="#"
                                                                       class="media-heading"><?php echo utf8_encode($articulo->titulo) ?></a>
                                                                </div>

                                                            </div>
                                                        </td>
                                                        <td class="text-left">
                                                            <a><?php echo utf8_encode($categoria->categoria) ?></a>
                                                        </td>
                                                        <td class="text-left">
                                                            <a><?php echo $articulo->fecha_creado ?></a>
                                                        </td>
                                                        <td>
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                    <a href="<?php url('articulo/vista#' .  utf8_encode($articulo->titulo) )?>"
                                       class="dropdown-item"><i class="ft-plus-circle primary"></i>Ir a la vista</a>
                                  <a href="<?php url('articulo/editar/' . $articulo->id . '/' . ('?page=editar')) ?>"
                                     class="dropdown-item"><i class="ft-edit-2"></i>Editar</a>
                                    <button id="eliminar" href="#" class="dropdown-item"
                                            onclick="confirmar('<?php url('articulo/eliminar/' . $articulo->id) ?>')"><i
                                                class="ft-trash-2"></i>Eliminar</button>
                                </span>
                              </span>
                                                        </td>
                                                    </tr>
